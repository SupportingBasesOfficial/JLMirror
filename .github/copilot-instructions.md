...
Total: 82 findings (1 critical, 9 warnings, 72 info)
...
- [any_type_usage] undefined: 4 `any` type usages in apps/api/src/middleware/validate.test.ts
...
- [orphan_env_var] GOOGLE_OAUTH_CLIENT_ID: Environment variable "GOOGLE_OAUTH_CLIENT_ID" is referenced...
- [orphan_env_var] GOOGLE_OAUTH_CLIENT_SECRET: Environment variable "GOOGLE_OAUTH_CLIENT_SECRET" is referenced...
...
- `apps/api/src/routes/feature-flags.ts` (route)
...
- `apps/web/app/(admin)/config-drift/page.tsx` (route)
- `apps/web/app/(admin)/correlation/page.tsx` (route)
- `apps/web/app/(admin)/dashboard/host-groups/page.tsx` (route)
- `apps/web/app/(admin)/dashboard/problems/page.tsx` (route)
- `apps/web/app/(admin)/dashboard/slas/page.tsx` (route)
