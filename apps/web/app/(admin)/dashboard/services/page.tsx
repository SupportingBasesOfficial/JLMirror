  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold" style={{ color: "var(--text-primary)" }}>Serviços</h1>
        <button
          onClick={() => mutate()}
      ...
      {isLoading ? (
        ...
        <div className="space-y-2">
          {services.map((s) => {
            ...
            return (
              <div key={s.serviceid} className="flex items-center gap-3 rounded-lg p-3" style={{ background: "var(--surface-2)", border: "1px solid var(--border-default)" }}>
                ...
                <StatusBadge variant={statusVariant} dot pulse={Number(status) >= 2}>
