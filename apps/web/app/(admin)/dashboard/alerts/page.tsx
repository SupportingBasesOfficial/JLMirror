      ...
      <div className="flex items-center justify-between">
        ...
        >
          <span className="flex items-center gap-1">
            ...
            />
            {criticalTriggers.length} crítico
          ...
          <div className="flex items-center gap-2 mb-2">
            <span
              ...
              style={{
                ...
                background: "var(--status-warning-text)",
                boxShadow:
                  "0 0 8px color-mix(in srgb, var(--status-warning-text) 40%, transparent)",
              }}
            />
            <span
              className="text-xs font-bold uppercase tracking-wider"
                  ...
                  <div className="flex items-center gap-3">
                    <span
                      ...
                      style={{
                        ...
                        background: "var(--status-warning-text)",
                        boxShadow:
                          "0 0 6px color-mix(in srgb, var(--status-warning-text) 40%, transparent)",
                      }}
                    />
                    <div className="flex-1 min-w-0">
                      <div
      ...
      {infoTriggers.length > 0 && (
        <div>
          <div className="flex items-center gap-2 mb-2">
            <span
              className="rounded-full"
              style={{ width: 8, height: 8, background: "var(--text-muted)" }}
            />
            <span
              className="text-xs font-bold uppercase tracking-wider"
              style={{ color: "var(--text-muted)" }}
