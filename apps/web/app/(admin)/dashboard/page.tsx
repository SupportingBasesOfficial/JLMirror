...
import { Server, Wifi, WifiOff, Bell, AlertTriangle, ChevronRight } from "lucide-react";
...
export default async function DashboardPage() {
  ...
  return (
    <div className="space-y-5" style={{ animation: "fadeIn 0.3s ease-out" }}>
      ...
      <Suspense fallback={<div className="h-48 animate-pulse rounded-xl" style={{ background: "var(--surface-2)" }} />}>
          ...
          {criticalCount > 0 && (
            <div>
              <div className="flex items-center gap-2 mb-2">
                <span className="rounded-full" style={{ width: 8, height: 8, background: "var(--status-error-text)", boxShadow: "0 0 8px var(--status-error-border)" }} />
                <span className="text-xs font-semibold uppercase tracking-wider" style={{ color: "var(--status-error-text)" }}>Críticos</span>
                ...
                {activeTriggers
                  ...
                  .map((t) => {
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <span className="rounded-full shrink-0" style={{ width: 6, height: 6, background: "var(--status-error-text)", boxShadow: "0 0 6px var(--status-error-border)" }} />
                ...
                {activeTriggers
                  ...
                  .map((t) => {
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <span className="rounded-full shrink-0" style={{ width: 6, height: 6, background: "var(--status-warning-text)", boxShadow: "0 0 6px var(--status-warning-border)" }} />
                          <div className="flex-1 min-w-0">
                            <div className="text-sm font-medium truncate" style={{ color: "var(--text-primary)" }}>
                              {t.description}
                            </div>
