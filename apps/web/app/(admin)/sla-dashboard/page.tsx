...
export default function SLADashboardPage() {
  ...
  if (error) {
    const isModuleDisabled =
      typeof error === "string" &&
      (error.includes("MODULE_DISABLED") || error.includes("não está ativado"));
    return (
      <div
      ...
      >
        <div className="text-center max-w-md">
          ...
          />
          <h2 className="text-sm font-bold mb-2" style={{ color: COLORS.text }}>
            Módulo SLA Dashboard Desativado
          </h2>
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[12px]" style={{ color: COLORS.muted }}>
            SLA em tempo real ·{" "}
            {new Date(dashboard.period.start).toLocaleDateString("pt-BR")} até
            agora
            {data?.cached && (
              <span className="ml-2" style={{ color: COLORS.amber }}>
                (cached)
              </span>
            )}
          </p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <StatCard
          label="MTTR Máximo"
          value={formatMinutes(num(dashboard.incidents.max_mttr_minutes))}
          color={COLORS.amber}
      ...
      {dashboard.trend.length > 0 && (
        ...
        >
          <h3
            ...
            style={{ color: COLORS.muted }}
          >
            Tendência de SLA (Últimos 7 dias)
          </h3>
                ...
                return (
                  ...
                  >
                    ...
                    <td
                      ...
                      style={{
                        color: slaPct >= target ? COLORS.green : COLORS.red,
                      }}
                    >
