...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Auditoria", href: "/security/audit", icon: <ScrollText {...iconProps} />, flagKey: "module_audit" },
    ],
  },
  {
    title: "Segurança",
    items: [
      ...
      { label: "Auditoria", href: "/security-audit", icon: <ShieldCheck {...iconProps} />, flagKey: "module_security_audit" },
    ],
  },
  {
